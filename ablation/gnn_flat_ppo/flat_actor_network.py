...
class FlatActorNetwork(nn.Module):
    ...
    def __init__(self,
                 input_dim: int = config.gcn_out_dim,
                 hidden_dim: int = 128,
                 num_layers: int = 3,
        ...
        self.register_buffer("residual_scale", torch.tensor(residual_scale, dtype=torch.float32).view(1, 3))
